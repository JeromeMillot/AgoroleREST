...
public class JwtParserTest extends TestCase {
	...
	private String tokenTest = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJjYXN0ZWxnb3VseiIsImlzcyI6Ikdyb3VwZUpEUiIsIm5hbWUiOiJKb2huIERvZSIsImlhdCI6MTUxNjIzOTAyMn0.Aui-Jbj6iCRuhYjpgb5-jBCTtzYAtmFSYcWTgBWxDlc";

	 public void testBed() throws InvalidClaimException, TokenExpiredException, AlgorithmMismatchException, JWTVerificationException, IllegalArgumentException, UnsupportedEncodingException {
	 	assertNotNull(lireJeton(tokenTest, "secret"));
	 } 
			...
			throws JWTVerificationException,  InvalidClaimException, TokenExpiredException, AlgorithmMismatchException, IllegalArgumentException, UnsupportedEncodingException
	{
		...
		JWTVerifier verifier = JWT.require(algorithm)
				.withIssuer("GroupeJDR").acceptExpiresAt(0)
				.build(); 
